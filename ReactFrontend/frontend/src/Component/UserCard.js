...
export default class FetchBooking extends Component {
    constructor(props) {
        super(props)
    ...
    editBooking(id){
      ...
      this.props.history.push('/fetchbooking');
        ...
        return (
            <div className="driver1">
                ...
                <div className="row">
                {
                    ...
                    this.state.list.filter(li=>li.role=='DRIVER').map(li=>
              ...
              <Button variant="btn btn-success" onClick={() => history.push('/Products')}>Click button to view products</Button>
                         ...
                         <Link
               to='/booking'  
                  // onClick={ () => this.editBooking(li.id)}
                className='nav-links'
               style={{color:'black'}}
              >
                Book Now
